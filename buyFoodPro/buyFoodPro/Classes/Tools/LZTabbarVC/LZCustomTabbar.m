...
- (UIButton *) button
{
    if (_button == nil)
    {
        ...
        UIImage *normalImage = [UIImage originImage:[UIImage imageNamed:@"charge"] scaleToSize:CGSizeMake(70, 70)];
        UIImage *selectedImage = [UIImage originImage:[UIImage imageNamed:@"charge_S"] scaleToSize:CGSizeMake(70, 70)];
