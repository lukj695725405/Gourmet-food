...
- (instancetype)initPageViewControllerWithControllers:(NSArray *)controllers
    ...
    self.bgScrollView.backgroundColor=[UIColor colorWithRed:0.96 green:0.97 blue:0.98 alpha:1.00];
    self.pageScrollView.backgroundColor=self.bgScrollView.backgroundColor;
    return self;
}
