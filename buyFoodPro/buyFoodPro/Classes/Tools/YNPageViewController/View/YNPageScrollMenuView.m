...
#warning 修改间距
    self.scrollView.frame = CGRectMake(0, 5, self.configration.showAddButton ? self.yn_width - self.yn_height - 30 : self.yn_width, self.yn_height-20);
    self.scrollView.backgroundColor = [UIColor whiteColor];
    self.scrollView.layer.masksToBounds = YES;
    self.scrollView.layer.cornerRadius = 0;
    [self addSubview:self.scrollView];
    if (self.configration.showAddButton) {
        self.addButton.frame = CGRectMake(self.yn_width - self.yn_height, 0, self.yn_height, self.yn_height-20);
    ...
    __block CGFloat itemH = self.yn_height - self.configration.lineHeight-20;
